...
let paragraphs = document.querySelectorAll('p.kt-control-row__title');
let values = Array.from(paragraphs).map(paragraph => paragraph.innerText);
console.log(values);




const descriptions = Array.from(document.querySelectorAll('div.kt-base-row__description.kt-body--sm')).map(div => div.textContent.trim());
